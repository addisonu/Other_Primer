...
print "<table border =\"1\" width = \"45%\">";
	...
	$query = "select student_first, student_mi, student_s_last, faculty.f_first, faculty.f_mi, faculty.f_last, faculty.f_phone from student_s inner join faculty where student_id = faculty.f_id order by faculty.f_last;";	
